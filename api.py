...
def scrape_amazon():
    ...
    max_reviews = data.get('max_reviews', 10)  # Default to 10 reviews if not provided
    ...
    # Scroll and scrape until the desired number of reviews is reached
    reviews = []
    locations = []
    ...
    outs = [[review, location] + model_out
            for review, location, model_out in zip(english_reviews, locations, model_outs)]
